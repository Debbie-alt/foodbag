...
const checkmeal3 = require('../../assets/checkmeal3.jpg')
    ...
    <View style={tailwind('flex-1')}>
      ...
      <View style={tailwind('bg-red-500 h-1/2 w-full rounded-bl-full justify-end py-10 items-center')}>
         <View style = {tailwind('relative mt-4')}>
          <Image source={checkmeal3} style={ [ tailwind('mx-2 rounded-2xl border-4 border-white'), { width: 140, height: 140 }  ]} />

           
         </View>
        <View
        style={tailwind('flex flex-row items-center bottom-10 z-20')}>
          <Image source={checkmeal2} style={ [ tailwind('mx-2 rounded-2xl border-4 border-white'), { width: 140, height: 140 }  ]} />
          <Image source={checkmeal1} style={ [ tailwind('mx-2 rounded-bl-2xl rounded-tl-2xl  rounded-tr-2xl border-4 border-white'), { width: 140, height: 140 }  ]} />
      ...
      <View style={tailwind('h-1/2 w-full items-center px-6')}>
        ...
        <Text style={tailwind('text-3xl font-medium  py-10 text-black')}>
          Check for your meals
        </Text>

        <Text style={tailwind('text-center text-black text-xl mb-6')}>
